...
import com.anchor.dao.CableForceMeterDao;
 ...
 * 
 * @项目名称：BDSIMP 
 * @类名称：CableForceMeterService 
 * @类描述：
 * @作者：张庭伟         @创建时间：2018年9月2日下午4:03:45 
 * @修改人：                 @修改时间：
 * @备注： 
 * @version
 */
public class CableForceMeterService {

	CableForceMeterDao dao = new CableForceMeterDao();
...
//			double val2 =new BigDecimal(dPressure).setScale(2,BigDecimal.ROUND_HALF_UP).doubleValue();
			double cable_force = Double.parseDouble(String.valueOf(map.get("cable_force"))) - ref3;
