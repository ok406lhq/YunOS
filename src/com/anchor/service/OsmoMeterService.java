...
import com.anchor.dao.OsmoMeterDao;
...
/**
 * 
 * 项目名称：BDSIMP 类名称：OsmoMeterService 
 * 类描述：
 * 作者：张庭伟         创建时间：2018年7月20日上午10:34:21 
 * 修改人：                 修改时间：
 * 备注： 
 * @version
 */
public class OsmoMeterService {

	OsmoMeterDao dao = new OsmoMeterDao();
...
//			double val2 =new BigDecimal(dPressure).setScale(2,BigDecimal.ROUND_HALF_UP).doubleValue();
			double dWaterDeepth = Double.parseDouble(String.valueOf(map.get("water_deepth"))) - ref3;
			double val3 =new BigDecimal(dWaterDeepth).setScale(2,BigDecimal.ROUND_HALF_UP).doubleValue();
//			object.put("dStrain", val1);
//			object.put("dPressure", val2);
			object.put("dWaterDeepth", val3);
