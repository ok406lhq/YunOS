...
// *
// * @项目名称：BDSIMP
// * @类名称：ClinoMeterService
// * @类描述：
// * @作者：张庭伟         @创建时间：2018年9月2日下午5:21:05
// * @修改人：                 @修改时间：
// * @备注：
// * @version
// */
//public class ClinoMeterService0 {
//
...
//		for (Map<String, Object> map : list) {
//			object = new JSONObject();
//			double dStrain = Double.parseDouble(String.valueOf(map.get("x"))) - ref;
...
//			double cable_force = Double.parseDouble(String.valueOf(map.get("y"))) - ref3;
