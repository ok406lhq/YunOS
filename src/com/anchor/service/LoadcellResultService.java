...
public class LoadcellResultService {

	
	
	//查询项目信息
	public String QueryLoadcellResult(Connection con, String prjName, String sensorName,String starttime,String endtime,String ymw)
	{
		String json="";
		try{
			LoadcellResultDao loadcellResultDao = new LoadcellResultDao();     
			json = loadcellResultDao.queryLoadcellResultJson(con, prjName, sensorName,starttime,endtime,ymw);
