...
public class LrdmResultService {

	
	
	//查询项目信息
	public String QueryLrdmResult(Connection con, String prjName, String sensorName,String starttime,String endtime,String ymw)
	{
		String json="";
		try{
			LrdmResultDao LrdmResultDao = new LrdmResultDao();     
			json = LrdmResultDao.queryLrdmResultJson(con, prjName, sensorName,starttime,endtime,ymw);
