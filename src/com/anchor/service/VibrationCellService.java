...
import com.anchor.dao.VibrationCellDao;
 ...
 * 
 * @项目名称：BDSIMP 
 * @类名称：VibrationCellService 
 * @类描述：
 * @作者：张庭伟         @创建时间：2018年9月2日下午6:04:01 
 * @修改人：                 @修改时间：
 * @备注： 
 * @version
 */
public class VibrationCellService {

	VibrationCellDao dao = new VibrationCellDao();
