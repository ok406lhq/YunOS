...
/**
 * 
 * 项目名称：BDSIMP 类名称：OsmoMeterDao 
 * 类描述：渗压计
 * 作者：张庭伟         创建时间：2018年7月20日上午10:31:39 
 * 修改人：                 修改时间：
 * 备注： 
 * @version
 */
public class OsmoMeterDao {
...
DBUtilsTemplate dbUtils = new DBUtilsTemplate();
	...
	public List<Map<String, Object>> initializeData(String params[]){
		String sql = "SELECT * from data_osmometer WHERE create_time BETWEEN ? AND ? AND sensor_id = ?";
