 ...
 * 
 * @项目名称：BDSIMP 
 * @类名称：TemperatureMeterDao 
 * @类描述：
 * @作者：张庭伟         @创建时间：2018年9月2日下午4:28:26 
 * @修改人：                 @修改时间：
 * @备注： 
 * @version
 */
public class TemperatureMeterDao {
...
DBUtilsTemplate dbUtils = new DBUtilsTemplate();
	...
	public List<Map<String, Object>> initializeData(String params[]){
		String sql = "SELECT * from data_temperaturemeter WHERE create_time BETWEEN ? AND ? AND sensor_id = ?";
