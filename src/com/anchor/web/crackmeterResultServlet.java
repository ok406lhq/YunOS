...
import com.anchor.service.LoadcellResultService;
import com.anchor.service.LrdmResultService;
import com.anchor.service.PiezometerResultService;
import com.anchor.service.PointInfoService;
import com.anchor.service.SystemLogService;
import com.anchor.service.crackmeterResultService;

import com.anchor.service.UssResultService;
 ...
 */
public class crackmeterResultServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public crackmeterResultServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			//{
				...
				if (prjName == null)
				{
					prjName = Connest.DefaultPrjName; //这个默认的
				}
				String sensorName = request.getParameter("sensorName");
				if (sensorName == null)
				{
					sensorName = "jl01"; //这个默认的
				}
				...
				crackmeterResultService ptInfoService =  new crackmeterResultService();
				
				String ptInfos = ptInfoService.QuerycrackmeterResult(con, prjName, sensorName,starttime,endtime,ymw);
				if (ptInfos == "")
				{
					request.setAttribute("error","无点位数据");
				}
			
				HtmlUtil.writerJson(response, ptInfos);
