...
import com.anchor.service.FlexoMeterService;
import com.anchor.util.HtmlUtil;

import net.sf.json.JSONArray;

/**
 * Servlet implementation class FlexoMeterServlet
 */
@WebServlet("/FlexoMeterServlet")
public class FlexoMeterServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	FlexoMeterService service = new FlexoMeterService();   
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FlexoMeterServlet() {
        super();
    }
