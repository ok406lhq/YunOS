...
/**
 * Servlet implementation class CableForceMeterServlet
 */
@WebServlet("/CableForceMeterServlet")
public class CableForceMeterServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	CableForceMeterService service = new CableForceMeterService();   
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CableForceMeterServlet() {
        super();
    }
