 ...
 */
public class LrdmResultServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LrdmResultServlet() {
        super();
...
//			{
				...
				if (sensorName == null)
				{
					sensorName = "LRDM1"; //这个默认的
				}
				
				String starttime=request.getParameter("starttime");
				String endtime=request.getParameter("endtime");
				String ymw=request.getParameter("ymw"); //周月年
				LrdmResultService ptInfoService =  new LrdmResultService();
				
				String ptInfos = ptInfoService.QueryLrdmResult(con, prjName, sensorName,starttime,endtime,ymw);
				if (ptInfos == "")
				{
