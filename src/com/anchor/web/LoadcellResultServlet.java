 ...
 */
public class LoadcellResultServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LoadcellResultServlet() {
        super();
...
//			{
				...
				if (sensorName == null)
				{
					sensorName = "AGMD1a"; //这个默认的
				}
				
				String starttime=request.getParameter("starttime");
				String endtime=request.getParameter("endtime");
				String ymw=request.getParameter("ymw"); //周月年
				LoadcellResultService ptInfoService =  new LoadcellResultService();
				
				String ptInfos = ptInfoService.QueryLoadcellResult(con, prjName, sensorName,starttime,endtime,ymw);
				if (ptInfos == "")
				{
