 ...
 */
public class piezometerResultServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public piezometerResultServlet() {
        super();
...
//			{
				...
				PiezometerResultService ptInfoService =  new PiezometerResultService();
				
				String ptInfos = ptInfoService.QueryPiezometerResult(con, prjName, sensorName,starttime,endtime,ymw);
				if (ptInfos == "")
				{
