...
import com.anchor.service.OsmoMeterService;
import com.anchor.util.HtmlUtil;

import net.sf.json.JSONArray;

/**
 * Servlet implementation class OsmoMeterServlet
 */
@WebServlet("/OsmoMeterServlet")
public class OsmoMeterServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	OsmoMeterService service = new OsmoMeterService();   
    /**
     * @see HttpServlet#HttpServlet()
     */
    public OsmoMeterServlet() {
        super();
    }
