 ...
 */
public class UssResultSevrlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UssResultSevrlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			if (null != con)
			{
				...
				if (sensorName == null)
				{
					sensorName = "ref1"; //这个默认的
				}
				
				String starttime=request.getParameter("starttime");
				String endtime=request.getParameter("endtime");
				String ymw=request.getParameter("ymw"); //周月年
				UssResultService ptInfoService =  new UssResultService();
			
				String ptInfos = ptInfoService.QueryUssResult(con, prjName, sensorName,starttime,endtime,ymw);
				if (ptInfos == "")
				{
