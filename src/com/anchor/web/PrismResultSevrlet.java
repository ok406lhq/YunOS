...
import com.anchor.service.PrismResultService;
 ...
 */
public class PrismResultSevrlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PrismResultSevrlet() {
        super();
...
//			{
				...
				if (sensorName == null)
				{
					sensorName = "SP001"; //这个默认的
				}
				
				String starttime=request.getParameter("starttime");
				String endtime=request.getParameter("endtime");
				String ymw=request.getParameter("ymw"); //周月年
				PrismResultService ptInfoService =  new PrismResultService();
				
				String ptInfos = ptInfoService.QueryPrismResult(con, prjName, sensorName,starttime,endtime,ymw);
				if (ptInfos == "")
				{
