    ...
    var t = function(t, n) {
        ...
        this.init = function() {
            ...
            if (e.isArray(t.data)) {
                ...
                t.$el.on("click", ".ui-table-sortable",
                function(n) {
                ...
                t.$el.on("click", ".ui-table-control-next, .ui-table-control-prev",
                function(n) {
                    t.page = e(this).data("columns-page");
                    t.pageHandler(n)
                });
                t.$el.on("keyup", ".ui-table-search",
                function(n) {
                    t.query = e(this).val();
                    t.searchHandler(n)
                });
                t.$el.on("change", ".ui-table-size select",
                function(n) {
    ...
    E.prototype.renderTokens = function(t, i, s, o) {
        ...
        p = t.length; h < p; ++h) {
            ...
            case "#":
                ...
                if (!c) continue;
                if (n(c)) for (var d = 0,
                v = c.length; d < v; ++d) u += this.renderTokens(l[4], i.push(c[d]), s, o);
