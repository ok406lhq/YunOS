(function($){
    $.fn.Huploadify = function(opts){
        var itemTemp = '<div id="${fileID}" class="uploadify-queue-item"><div class="uploadify-progress"><div class="uploadify-progress-bar"></div></div><span class="up_filename" style="display:none">${fileName}</span><a href="javascript:void(0);" class="uploadbtn"> 上传图片</a><a href="javascript:void(0);" class="delfilebtn">删除</a></div>';
        var defaults = {
