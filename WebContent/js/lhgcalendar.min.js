calendar = (function($) {
	...
	calendar.DEFAULT_OPTS =  calendarStr;
	...
	calendar.prototype = {
		...
		stringToDate: function(string) {
           ...
           */
				if(string.match(/^\d{4}[\-\/\s+]\d{1,2}[\-\/\s+]\d{1,2}$/)){
				return new Date(string.replace(/[\-\/\s+]/i,'/'))
				}else if(string.match(/^\d{8}$/)){
				return new Date(string.substring(0,4)+'/'+string.substring(4,6)+'/'+string.substring(6))
				}else{
				  return null
				}
		},
