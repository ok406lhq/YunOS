...
<script type="text/javascript">    //数据加载
    ...
    function getAjaxData() {
        ...
        if (typeof(selectedSensorName) == 'undefined'|| selectedSensorName=='') {
    ...
    function dataLoad(data) {
        ...
        if (typeof(selectStaName) == 'undefined') {
        ...
        $.each(data,function(index,result){
            ...
            ddisx.push(result.disX);
            ddisy.push(result.disY);
        });
        var option = {
            title: {
                left: 'center',
                text: selectStaName+'位移变化-时间曲线图',
            },
            tooltip: {
                trigger: 'axis'
            },
...
//导出表格表头中文映射
var chineseLaberMapping={dtDateTime:"数据时间",ddisx:"x方向位移",ddisy:"y方向位移"};
