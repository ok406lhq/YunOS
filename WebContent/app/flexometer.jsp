...
<body>
	...
	$.post("./../FlexoMeterServlet",data,function(data){
		var data = eval(data);
		var htmlStr = "";
			...
			$.post("./../FlexoMeterServlet",data,function(data){
				...
				var temp = 0;
					...
					$.each(data,function(index,result){
						...
						deflection.push(result.deflection);
