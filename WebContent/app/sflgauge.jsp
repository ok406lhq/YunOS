...
<body>
	...
	$.post("./../SflgaugeServlet",data,function(data){
		var data = eval(data);
		var htmlStr = "";
				...
				var temp = 0;
					...
					option = {
						...
						xAxis: {
				            ...
				            /* axisLabel:{
				                 //X轴刻度配置
				                 interval:80 //0：表示全部显示不间隔；auto:表示自动根据刻度个数和宽度自动设置间隔个数
				            } */
						},
						yAxis: {
							max: numY,
