...
<body style="height: 560px">
  ...
  <div class="layui-tab"> 
   <ul class="layui-tab-title"> 
    <li><a href="report_all.jsp">日常报表</a></li>
    <li><a href="report_analysis.jsp">分析报告</a></li>
    <li class="layui-this">预警报告</li> 
   </ul> 
   <!-- tab内容start --> 
   <div class="layui-tab-content"> 
    ...
    <!-- tab分析报告开始 --> 
       <div class="layui-tab-item" reportType="analysis" tableId="analysis">
        <%@ include file="report_warning_search.jsp" %>
        <table class="layui-hide" id="analysis" lay-filter="reportTable"></table> 
       </div> 
    <!-- tab分析报告结束 --> 
    <!-- tab预警报告开始 --> 
       <div class="layui-tab-item layui-show" reportType="warning" tableId="warning">
        <%@ include file="report_warning_search.jsp" %>
...
<script type="text/javascript">
  ...
  $(".J-dailyReport").click(function(){
        ...
        var warningLevel = $(this).parents(".compare-container").find(".selectWarning").val();
        ...
        if(startTime==''){
     	...
     	requestReport(tableId, reportType, projectId, warningLevel, startTime, endTime);
    }); 
...
<script type="text/javascript">
   ...
   function requestReport(tableId, reportType, projectId, warningLevel, startTime, endTime){
	   ...
	   table.render({
	     elem: '#'+tableId
	     //,height: 500
	     ,url: './../MonitorReportServlet?requestType=getReportWarning&reportType='+reportType+'&projectId='+projectId+'&warningLevel='+warningLevel+'&startTime='+startTime+'&endTime='+endTime //数据接口
	     ,page: true //开启分页
	     ,cols: [[ //表头
