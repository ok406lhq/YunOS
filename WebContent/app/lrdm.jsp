...
$(".graphicbtn").addClass("btn-success");
  ...
  getData(starttime,endtime,sensorName,PrjName,"");
    ...
    $.post("./../LrdmResultServlet",{"starttime":starttime,"endtime":endtime,"sensorName":sensorName,"prjName":PrjName,"ymw":ymw},function(data){
       tip_close();
     ...
     var datalist=eval("("+data+")");
        ...
        if(datalist.length>0){
           ...
           data: tableData,
                  schema: [
                    ...
                    {"header":"位移(mm)", "key":"displacement"},
                    {"header":"温度(°C)", "key":"temperature"},
                     {"header":"日期时间", "key":"date_"},
                    {"header":"位移(mm)", "key":"displacement_"},
        ...
        $.each(datalist,function(index,dataArr) {
         ...
         if(ymw=="month"){ad=dataArr.date+"-01 00:00:00";}
          ...
          hyetalArr[i][1]=Number(dataArr.displacement);
          // timeArr.push(dataArr.adddate);
          temperatureArr[i]=[];
         ...
         charts(hyetalArr,temperatureArr,timeArr,tickPixel,tipFormat);
        }else{
 ...
 function charts(hyetalArr,temperatureArr,timeArr,tickPixel,tipFormat){
    ...
    $('#container').highcharts('StockChart',{
      ...
      min:0,
        ...
        tooltip: {
         xDateFormat: tipFormat,valueDecimals: 2
      },
        legend: {
            enabled:true,
  ...
  enabled: true,
     ...
     credits: {
        ...
        series: [{
            ...
            yAxis: 1,
            data: hyetalArr, marker : {enabled : true,radius : 5},shadow : false,
            tooltip: {
                valueSuffix: ' mm'
            },
            ...
            color: '#89A54E',
            type: 'spline',lineWidth:1,
            data: temperatureArr, marker : {enabled : true,radius : 5},shadow : false,
            tooltip: {
                valueSuffix: '°C'
            }
        }]
