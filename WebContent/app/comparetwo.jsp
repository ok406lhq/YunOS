	...
	<div id="container" style="min-width: 310px; min-height: 420px; margin: 0 auto;clear:both"></div>
	    ...
	    <div class="panel panel-info">
	     <div class="panel-heading compare-panel">
		   <ul style="width:100%">
		     起始时间1：
		     <input type='text' class='start_time notifc' id='start_time' readonly="readonly"  > 
		     
		   &nbsp;&nbsp; 结束时间1：
		     <input type='text' class='end_time notifc' id='end_time' readonly="readonly"   > 
				起始时间2：
		     <input type='text' class='start_time notifc' id='start_time2' readonly="readonly"  > 
		     
		   &nbsp;&nbsp; 结束时间2：
		     <input type='text' class='end_time notifc' id='end_time2' readonly="readonly"   > 
	 ...
	 $.post("./../PointAll",{oper:"all",prjName:""},function(data){
         ...
         var data=eval("("+data+")");
			 ...
			 if(projectListArr.length>0){
				 sensorStr="<select class='sensornamelist' id='Sensorbox'>"
				  $.each(projectListArr,function(index,project){
					  ...
					  //<select class="sensornamelist"></select> <option
					 /*  sensorStr+="<div><input type='checkbox' value='"+SensorName+"' id='"+index+"' "+checked+" title='"+SensorType+"' name='sensor' >"+
					  ...
					  sensorStr+="<option value="+SensorName+">"+SensorName+"</option>";
				  })
				   sensorStr+="</select>";
			...
			$.each(e,function(index,adddateList) {
               ...
               if(adddateList.length>0){
				...
				var nameStr=index.split("/");
			       ...
			       seriesArr.push({name:sensorname ,
