    ...
    <div class="col-md-12 column" id="header">
        <form role="form" class="form-inline search_form">
            ...
            <div class="form-group">
                ...
                <select class="form-control-static static_select sensornamelist" id="station">
                </select>
            </div>
            <div class="form-group">
...
function dataLoad(data) {
    ...
    $.each(data,function(index,result){
        dtDateTime.push(result.createTime);
        ddisx.push(result.corrosionRate);
        ddisy.push(result.corrosionCurrent);
    });
    var option = {
        title: {
            left: 'center',
            text: selectStaName+'腐蚀度-时间曲线图',
        },
        tooltip: {
            trigger: 'axis'
        },
...
$.post("./../CableForceMeterServlet",data,function(data){
    var data = eval(data);
    var htmlStr = "";
    $.each(data,function(index,result){
...
//导出表格表头中文映射
var chineseLaberMapping={dtDateTime:"数据时间",ddisx:"x方向角度",ddisy:"y方向角度"};
