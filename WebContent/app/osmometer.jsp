...
<body>
	...
	$.post("./../OsmoMeterServlet",data,function(data){
		var data = eval(data);
		var htmlStr = "";
			...
			$.post("./../OsmoMeterServlet",data,function(data){
				...
				var temp = 0;
					...
					$.each(data,function(index,result){
						...
						dWaterDeepth.push(result.dWaterDeepth);
